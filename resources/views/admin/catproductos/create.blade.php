...
@section('breadcrumb')
	<li class="breadcrumb-item">
		<a href="{{ url('/admin/catproductos/'.$module) }}"><i class="fas fa-folder-open"></i> Categoria Productos</a>
	</li>
@endsection
			...
			<div class="col-md-12">
				<div class="panelprin shadow">
                    <div class="headercontent">
                        ...
                        <h2 class="title"><i class="fas fa-folder-open"></i> Categoria Productos: <strong>{{ $nombres[$module] }}</strong></h2>
                            <ul>
                            </ul>
                        </div>
					<div class="inside">
						{{-- {!! Form::open(['url'=>'/admin/categoria/add/'.$module]) !!} --}}
						{!! Form::open(['route'=>'admin.catproductos.store']) !!}
