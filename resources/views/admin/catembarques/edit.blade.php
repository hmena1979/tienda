			...
			<div class="col-md-12">
				<div class="panelprin shadow">
                    <div class="headercontent">
                        ...
                        <h2 class="title"><i class="fas fa-folder-open"></i> Categoría Embarques: <strong>{{ $nombres[$catembarque->modulo] }}</strong></h2>
                            <ul>
                            </ul>
                        </div>
					<div class="inside">
						{!! Form::model($catembarque,['route'=>['admin.catembarques.update',$catembarque], 'method' => 'put']) !!}
