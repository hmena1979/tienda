	...
	<div class="container-fluid">
        ...
        <div class="row mtop16">
            <div class="col-md-12">
                <div class="panelprin shadow">
                    <div class="headercontent">
                        <h2 class="title"><i class="fas fa-chart-pie"></i> Detalle de Destinos</h2>
                        <ul>
...
<script>
    ...
    var tabladet = $(document).ready(function(){
        ...
        $('#add').click(function(){
            ...
            $.get(url_global+"/admin/destinos/"+envio+"/aedet/",function(response){
                if (response == 1) {
                    veritems();
                    $('#aedet').hide();
                    $('#detalles').show();
    ...
    function veritems(){
        $.get(url_global+"/admin/destinos/"+$('#id').val()+"/tablaitem/",function(response){
            $('#tdetitem').empty();
    ...
    function edititem (id) {
        ...
        $.get(url_global+"/admin/destinos/"+id+"/detdestino/",function(response){
    ...
    function destroyitem(id){
		Swal.fire({
            ...
            if (result.value) {
				$.get(url_global+"/admin/destinos/"+id+"/destroyitem/",function(response){
                    veritems();
                    Swal.fire({
                        icon:'success',
                        title:'Eliminado',
