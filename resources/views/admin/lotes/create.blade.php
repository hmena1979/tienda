		...
		<div class="row">
			<div class="col-md-12">
				<div class="panelprin shadow">
					{!! Form::open(['route'=>'admin.lotes.store']) !!}
					...
					<div class="inside">
						<div class="row">
							...
							<div class="col-md-2 form-group">
                                ...
                                {!! Form::date('finicial', Carbon\Carbon::now(), ['class'=>'form-control activo']) !!}
                            </div>
							<div class="col-md-2 form-group">
                                {!! Form::label('ffinal', 'Fecha Término:') !!}
                                {!! Form::date('ffinal', Carbon\Carbon::now(), ['class'=>'form-control activo']) !!}
                            </div>
						</div>
					</div>				
					{!! Form::close() !!}
