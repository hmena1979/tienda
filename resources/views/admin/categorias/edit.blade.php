...
@section('breadcrumb')
	<li class="breadcrumb-item">
		<a href="{{ url('/admin/categorias/'.$categoria->modulo) }}"><i class="fas fa-folder-open"></i> Categorias</a>
	</li>
@endsection
			...
			<div class="col-md-12">
				<div class="panelprin shadow">
                    <div class="headercontent">
                        ...
                        <h2 class="title"><i class="fas fa-folder-open"></i> Categorias: <strong>{{ $nombres[$categoria->modulo] }}</strong></h2>
                            <ul>
                            </ul>
                        </div>
					<div class="inside">
