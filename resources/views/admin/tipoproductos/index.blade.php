				...
				<div class="panelprin shadow">
					<div class="headercontent">
						...
						<ul>
							...
							<li>
								<a href="{{ route('admin.tipoproductos.create') }}">
									Agregar registro
								</a>
							</li>
							@endcan
								...
								<tr>
									...
									<td>
										<div class="opts">
											...
											<a class="" href="{{ route('admin.tipoproductos.edit',$tipoproducto) }}"datatoggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a>
											@endcan
											@can('admin.tipoproductos.destroy')
											<form action="{{ route('admin.tipoproductos.destroy',$tipoproducto) }}" method="POST" class="formulario_eliminar">
												@csrf
												@method('delete')
