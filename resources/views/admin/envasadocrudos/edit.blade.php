...
@section('breadcrumb')
	<li class="breadcrumb-item">
		<a href="{{ route('admin.envasadocrudos.index') }}"><i class="far fa-clipboard"></i> Planilla de Envasado @if ($envasado->tipo == 2) Crudo @endif</a>
	</li>
@endsection
...
@section('contenido')
	...
	<div class="container-fluid">
		<div class="row" id = 'agregarcomprobante'>
            <div class="col-md-12">
                {!! Form::model($envasado,['route'=>['admin.envasadocrudos.update',$envasado], 'method'=>'put']) !!}
				<div class="panelprin shadow">
                    <div class="headercontent">
						...
						<ul>
                            ...
                            @can('admin.envasadocrudos.aprobar')
                            <li>
                                <a class="btn btn-convertir mt-1" href="{{ route('admin.envasadocrudos.aprobar',$envasado) }}">Aprobar</a>
                            </li>
                            @endcan
                            @endif
                            ...
                            @can('admin.envasadocrudos.aprobar')
                            <li>
                                <a class="btn btn-convertir mt-1" href="{{ route('admin.envasadocrudos.abrir',$envasado) }}">Permitir Editar</a>
                            </li>
                            @endcan
                            @endif
                            <li>
        ...
        <div class="row mtop16 oculto" id="aeitem">
			<div class="col-md-12">
				<div class="panelprin shadow">
					...
					<div class="inside">
                        {!! Form::open(['route'=>'admin.envasadocrudos.additem', 'id'=>'formdetalle']) !!}
                        <div class="row">
                            <div class="col-md-2 form-group">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#add').click(function(){
            ...
            $.ajax({
                url: "{{ route('admin.envasadocrudos.additem') }}",
                type: "POST",
                async: true,
    ...
    function veritems(){
		var id = $('#id').val();
		$.get(url_global+"/admin/envasadocrudos/"+id+"/tablaitem/",function(response){
			$('#tdetitem').empty();
    ...
    function edititem (id) {
        ...
        $.get(url_global+"/admin/envasadocrudos/"+id+"/detenvasado/",function(response){
    ...
    function destroyitem(id){
		Swal.fire({
            ...
            if (result.value) {
				$.get(url_global+"/admin/envasadocrudos/"+id+"/destroyitem/",function(response){
                    veritems();
                    Swal.fire({
                        icon:'success',
                        title:'Eliminado',
