...
@section('title','Planilla de Envasado Crudo')

@section('breadcrumb')
	<li class="breadcrumb-item">
		<a href="{{ route('admin.envasadocrudos.index') }}"><i class="far fa-clipboard"></i> Planilla de Envasado Crudo</a>
	</li>
@endsection
			...
			<div class="col-md-12">
				<div class="panelprin shadow">
					<div class="headercontent">
						<h2 class="title"><i class="far fa-clipboard"></i> Planilla de Envasado Crudo</h2>
						<ul>
							<li>
                                <div class="cita mt-2">
                                    {!! Form::open(['route'=>'admin.envasadocrudos.change']) !!}
							...
							@can('admin.envasadocrudos.create')
							<li>
								<a href="{{ route('admin.envasadocrudos.create') }}">
									Agregar registro
								</a>
							</li>
							@endcan
						...
						<table id= "gridv" class="table table-responsive table-hover">
							...
							<tbody>
								...
								">
									...
									<td>
										<div class="opts">
											@can('admin.envasadocrudos.edit')
											<a class="" href="{{ route('admin.envasadocrudos.edit',$envasado) }}"datatoggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a>
											@endcan
											@can('admin.envasadocrudos.destroy')
											<form action="{{ route('admin.envasadocrudos.destroy',$envasado) }}" method="POST" class="formulario_eliminars">
												@csrf
												@method('delete')
